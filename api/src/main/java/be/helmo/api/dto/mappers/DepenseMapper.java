...
public class DepenseMapper {
    public static DepenseDTO toDTO(Depense depense) {
        ...
        return new DepenseDTO(depense.getId(), depense.getName(), depense.getMontant(), depense.getDevise().getDevise(), depense.getDate(), categorieDTO, goalsDTO, depense.getUtilisateur().getId());
    }
